         ...
         <div class="col-md-12">
             <div class="card">
                 <div class="card-header">
                     <a href="{{route('barangmasuk.create')}}" class="btn btn-sm btn-primary float-right">Tambah Kategori</a>
                </div>
                            ...
                            <tr>
                                ...
                                <th>
                                    <form action="{{route('barangmasuk.destroy',$data->id)}}" method="post">
                                        @method('delete')
                                        @csrf
                                        <a href="{{route('barangmasuk.edit',$data->id)}}" class="btn btn-info">Edit</a>
                                        <a href="{{route('barangmasuk.show',$data->id)}}" class="btn btn-warning">Show</a>
